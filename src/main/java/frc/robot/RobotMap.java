...
public class RobotMap {
    ...
    public static final int SOLENOID_PANEL_FORWARD_ID = 0;
    public static final int SOLENOID_PANEL_REVERSE_ID = 1;
    public static final int SOLENOID_PANEL_PUSH_ID = 2;
    public static final int SOLENOID_PANEL_UNPUSH_ID = 3;
    public static final int SOLENOID_CARGO_RAISE_ID = 4;
